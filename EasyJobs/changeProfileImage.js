...
(async function fillJobPostExample() {
  ...
  try {
    ...
    await driver.wait(
      until.elementLocated(
        By.css("a.button.primary-button[href='/job/create']")
      ),
      10000
    );
    await driver
      .findElement(By.css("a.button.primary-button[href='/job/create']"))
      .click();
    console.log("Clicked the 'Create a job post' button");

    await driver.findElement(By.css("button[type='submit']")).click();
    console.log("Job post saved and continue clicked");

    await driver.get("https://app.easy.jobs/my-account/information");
    console.log("Navigated to the My Account Information page");

    const imagePath = path.resolve(
      "/home/arafat/Pictures/img/selenium-test-automation.png"
    );
    ...
    await driver.wait(
      until.elementLocated(By.css("button[class='button success-button']")),
      10000
    );
    await driver
      .findElement(By.css("button[class='button success-button']"))
      .click();
    console.log("Clicked the success button");
  } catch (error) {
